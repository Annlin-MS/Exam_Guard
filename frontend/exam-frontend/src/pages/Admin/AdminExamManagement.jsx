...
const AdminExamManagement = () => {
  ...
  // filtered list shown in enroll modal
  ...
  <div style={s.detail}>
    ...
    <span>{exam.enrolled_count || 0} enrolled</span>
                  ...
                  <div style={s.actions}>
                    ...
                    {(statusKey === "APPROVED" || statusKey === "LOCKED") && (
                  ...
                  <div key={st.id} className="enroll-row"
                    ...
                    <div style={{ flex:1 }}>
                      ...
                      <div style={{ fontSize:11, color:"rgba(26,26,46,0.45)" }}>
                        Roll: {st.roll_number || "—"} · {st.email}
                      </div>
                    </div>

                    {/* Dept + Sem */}
                    <div style={{ textAlign:"right", flexShrink:0 }}>
                      <div style={{ fontSize:11, fontWeight:700, padding:"3px 8px", borderRadius:6, background:"rgba(108,99,255,0.08)", color:"#6C63FF", marginBottom:2 }}>
                        {st.department}
                      </div>
